 ...
 */
final class Version20220818130448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE core_agency ADD creator_id_id INT NOT NULL');
        $this->addSql('ALTER TABLE core_agency ADD CONSTRAINT FK_D09CA5BFF05788E9 FOREIGN KEY (creator_id_id) REFERENCES core_user (id)');
        $this->addSql('CREATE INDEX IDX_D09CA5BFF05788E9 ON core_agency (creator_id_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE core_agency DROP FOREIGN KEY FK_D09CA5BFF05788E9');
        $this->addSql('DROP INDEX IDX_D09CA5BFF05788E9 ON core_agency');
        $this->addSql('ALTER TABLE core_agency DROP creator_id_id');
    }
}
