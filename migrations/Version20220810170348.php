 ...
 */
final class Version20220810170348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE access_token (id INT AUTO_INCREMENT NOT NULL, attributes LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', single_use_token VARCHAR(255) DEFAULT NULL, punchout TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
