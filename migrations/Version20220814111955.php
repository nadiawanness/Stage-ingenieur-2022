 ...
 */
final class Version20220814111955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE core_organization ADD assigned_to INT DEFAULT NULL');
        $this->addSql('ALTER TABLE core_organization ADD CONSTRAINT FK_6C5EDAA489EEAF91 FOREIGN KEY (assigned_to) REFERENCES core_user (id)');
        $this->addSql('CREATE INDEX IDX_6C5EDAA489EEAF91 ON core_organization (assigned_to)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE core_organization DROP FOREIGN KEY FK_6C5EDAA489EEAF91');
        $this->addSql('DROP INDEX IDX_6C5EDAA489EEAF91 ON core_organization');
        $this->addSql('ALTER TABLE core_organization DROP assigned_to');
    }
}
