 ...
 */
final class Version20220818123126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE core_agency ADD core_organization_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE core_agency ADD CONSTRAINT FK_D09CA5BF4F346186 FOREIGN KEY (core_organization_id) REFERENCES core_organization (id)');
        $this->addSql('CREATE INDEX IDX_D09CA5BF4F346186 ON core_agency (core_organization_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE core_agency DROP FOREIGN KEY FK_D09CA5BF4F346186');
        $this->addSql('DROP INDEX IDX_D09CA5BF4F346186 ON core_agency');
        $this->addSql('ALTER TABLE core_agency DROP core_organization_id');
    }
}
